...
%changelog
* Fri May 8 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.87-1.rpi
- Update to stable kernel patch v6.12.87
- Sync RPi patch to git revision: ae4d75fb36deba0fe1a986d9bfae65755e082dd0

* Thu May 7 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.86-1.rpi
- Update to stable kernel patch v6.12.86
- Sync RPi patch to git revision: 725b41be77c69541becda6f1f86b5fc5c0b9104e

* Thu Apr 30 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.85-1.rpi
- Update to stable kernel patch v6.12.85
- Sync RPi patch to git revision: effcbc88e3ab970a2d2aafdfe7c9333766f7139a

* Wed Apr 22 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.83-1.rpi
- Update to stable kernel patch v6.12.83
- Sync RPi patch to git revision: 7ee4e3228980c49dada14ec98dd74c5dcfdddafc

* Tue Apr 21 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.82-1.rpi
- Update to stable kernel patch v6.12.82
- Sync RPi patch to git revision: 5baf7a0541d5e2203d2e3b661b49dbf74ba0fc24

* Tue Apr 14 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.81-1.rpi
- Update to stable kernel patch v6.12.81
- Sync RPi patch to git revision: bc0c440ce8a9ba7dbcd22fcee403ef91daf5a9ec

* Thu Apr 9 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.80-1.rpi
- Update to stable kernel patch v6.12.80
- Sync RPi patch to git revision: abfc9539d899f2ba484ecdaa51def05b4db13b54

* Sat Mar 28 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.79-1.rpi
- Update to stable kernel patch v6.12.79
- Sync RPi patch to git revision: 5f23da14d91d4ba66604ec75453564e4e2afc57e

* Thu Mar 26 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.78-1.rpi
- Update to stable kernel patch v6.12.78
- Sync RPi patch to git revision: 02de8371e6cb23f25bb853217f758aa28664ad00
...
* Thu Feb 26 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.12.73-1.rpi
