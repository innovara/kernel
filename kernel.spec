...
%changelog
* Tue Sep 8 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.50-1.rpi
- Update to stable kernel patch v6.18.50
- Sync RPi patch to git revision: 0ac97ba3443f519b61bbc96079736cd8b881ea22

* Sat Aug 29 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.48-1.rpi
- Update to stable kernel patch v6.18.48
- Sync RPi patch to git revision: b3aefe19d14cf15f2e41dfd269fa0ca6198dacd2

* Tue Aug 25 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.46-1.rpi
- Update to stable kernel patch v6.18.46
- Sync RPi patch to git revision: 16f1da3c4e94437449d6aa151589ca0ad4b388bb

* Fri Aug 21 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.45-1.rpi
- Update to stable kernel patch v6.18.45
- Sync RPi patch to git revision: 65495647821026e14223095d1b0124aa3d502dec

* Mon Aug 10 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.44-1.rpi
...
* Wed Jul 29 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.40-1.rpi
- Update to stable kernel patch v6.18.40
- Sync RPi patch to git revision: 741426f4bc591beb37116a6d97d422a2d4f988b6

* Thu Jul 23 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.39-1.rpi
- Update to stable kernel patch v6.18.39
- Sync RPi patch to git revision: 820b5b663c24c6168d8aae4469ab490158a4b709

* Mon Jul 13 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.38-1.rpi
- Update to stable kernel patch v6.18.38
- Sync RPi patch to git revision: 10214efa1a114fc61131ff1e1240fd5a0f170803

* Wed Jul 1 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.37-1.rpi
- Update to stable kernel patch v6.18.37
- Sync RPi patch to git revision: 9df439fbf76c0cb9f1a9282a7bf44b3405d51690

* Fri Jun 19 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.36-1.rpi
- Update to stable kernel patch v6.18.36
- Sync RPi patch to git revision: 954341c412dd48b7c7f8125d81212ec4c0e42ed3

* Tue Jun 9 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.35-1.rpi
- Update to stable kernel patch v6.18.35
- Sync RPi patch to git revision: 57083d8cf8f0c5f2e9f97ed79d5fe2382a20d3d4

* Thu Jun 4 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.34-1.rpi
- Update to stable kernel patch v6.18.34
- Sync RPi patch to git revision: ac2010ab872809cefb790183949b11bdf22db647

* Tue May 26 2026 Manuel Fombuena <mfombuena@innovara.tech> - 6.18.33-1.rpi
- Update to stable kernel patch v6.18.33
- Sync RPi patch to git revision: fd096e09fd907d39e8378f6ea5bca47c2e7b1277
